...
const ConfirmRide = (props) => {
  ...
  return (
    <div className='flex items-center flex-col'>
         <h5 onClick={()=>{
        props.setConfirmRidePanel(false)}} className="p-3 text-center w-full absolute top-0"> <i className="text-xl text-gray-400  ri-arrow-down-wide-line"></i></h5>
       ...
       <div className='flex items-center flex-col justify-between gap-4'>
        ...
        <button onClick={()=>{
            ...
            props.createRide()
        }} className='w-full mt-2 bg-green-600 text-lg font-medium text-white rounded-3xl'>Confirm</button>
       </div>
    </div>
  )
}
